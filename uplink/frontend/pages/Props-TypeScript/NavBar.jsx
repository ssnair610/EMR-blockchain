...
function withAction(props) {
    ...
    if (props.name === '' || props.name === undefined) {
        ...
        menu = (<react_1.Menu>
                ...
                <react_1.MenuList>
                    <react_1.Link href={'/profile/'} style={{ textDecoration: 'none' }}><react_1.MenuItem>Profile</react_1.MenuItem></react_1.Link>
                    <react_1.Link href={'/settings'} style={{ textDecoration: 'none' }}><react_1.MenuItem>Settings</react_1.MenuItem></react_1.Link>
                    <react_1.MenuDivider />
                    <react_1.MenuItem>
