...
import (
	"CapStone/controllers"        // controllers contains homeController.go file which will render the main html/tmpl file when the local server is running.
	"CapStone/initializers"       // initializers contains envVars.go which will load in the required environment variables.
